		...
		content: [
			{
				...
				details: [
					...
					'Fostered growth among junior engineers by providing mentorship and personalized growth plans while improving recruitment processes with a developer candidate testing platform.',
					'Actively participated in code reviews, wrote api documentation, and designed unit tests to ensure high-quality code and seamless deployment',
